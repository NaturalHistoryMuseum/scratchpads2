<?php
/**
 * @file lexicon-block-term.tpl.php
 * Default theme implementation for displaying a single Lexicon term in the Lexicon random term block.
 *
 ...
 *    - $term->link: the link to the term (if enabled) as a named array containing link["path"] and link["fragment"].
 ...
 *    - $term->adminlinks: the adminlinks (if any) in an array containing ["name"], ["path"] and ["attributes"] per element.
 */
?>
