 ...
 *               class L.polyline by methods runEdit() and stopEdit()<br/>
...
/**
 * @name L.polyline
 * @class Extends standart class L.polyline by methods runEdit() and
 *        stopEdit()
 */
if(typeof google != 'undefined' && typeof (L.polyline.prototype.runEdit) === "undefined") {
  /**
   ...
   *          segment
   */
  L.polyline.prototype.runEdit = function(flag){
    if(!flag) {
      flag = true;
    }
    var self = this;
    if(flag) {
      ...
      var ghostPath = new L.polyline({map: this.getMap(), strokeColor: this.strokeColor, strokeOpacity: 0.2, strokeWeight: this.strokeWeight});
...
if(typeof google != 'undefined' && typeof (L.polyline.prototype.stopEdit) === "undefined") {
  /**
   * Stops editing polyline
   */
  L.polyline.prototype.stopEdit = function(){
    this.getPath().forEach(function(vertex, inex){
      if(vertex.marker) {
