(function($) {
    ...
    var SlickEditor = {
        ...
        /*
         * This opens the field from the entity form in a popup
         * This *should* work for all field & entity types
        ...
        ModalForm: function(args) {
            ...
            this.init = function() {
                ...
                // Set up an ajax commmand to handle the modal form response
                Drupal.ajax.prototype.commands.modal_slickgrid = scope.modalResponse;

                // Open a CTools modal dialog
                Drupal.CTools.Modal.show('ctools-modal-slickgrid');
                
                $('.slickgrid-modal-close').bind('click', scope.cancel);
            ...
            // Modal form has responded
            this.modalResponse = function(ajax, data, status) {
              
              args.commitChanges();
              slickgrid.callbackSuccess(data.response, true);  
            ...
            this.applyValue = function(item) {
                // Loop through all entity IDs returned by the & set all values
