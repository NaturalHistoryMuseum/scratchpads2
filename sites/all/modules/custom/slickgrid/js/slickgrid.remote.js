(function($){
  ...
  function RemoteModel(url){
    ...
    function ensureData(from, to){
      ...
      var url = url + searchstr + "&offset=" + (fromPage * PAGESIZE) + "&count=" + (((toPage - fromPage) * PAGESIZE) + PAGESIZE) + "&appkey=http://slickgrid.googlecode.com&type=javascript";
      ...
      h_request = setTimeout(function(){
        ...
        req = $.jsonp({url: url, callbackParameter: "callback", cache: true, // Digg
                                                                              // doesn't
                                                                              // accept
                                                                              // the
                                                                              // autogenerated
