  ...
  Drupal.behaviors.characterEditor = {attach: function(context, settings){
    ...
    if(typeof Drupal.settings.CharacterEditorInit === 'undefined' || !Drupal.settings.CharacterEditorInit) {
      ...
      $slick.bind('onSlickgridInit', function(event, slickgrid){
        // Create the tree
        Drupal.characterTreeUI = new Drupal.CharacterTreeUI(Drupal.settings.CharacterTreeUI.mode, Drupal.settings.CharacterTreeUI.width, Drupal.settings.CharacterTreeUI.tree, context, slickgrid);
        ...
        // Alter Slickgrid ajax call to specifiy which character project this is
        // (slickgrid typically
